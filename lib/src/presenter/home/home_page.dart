                ...
                children: [
                  Padding(
                    ...
                    child: SvgPicture.asset(
                      "assets/images/open_drawer_icon.svg",
                      height: height * 2,
                    ),
                  ),
                  Padding(
                    padding:
                        EdgeInsets.only(top: height * 2, bottom: height * 0.5),
                    child: Text(
                      "Olá, Alef",
                    ...
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                          Padding(
                            padding:
                                EdgeInsets.symmetric(horizontal: height * 1.5),
                            child: Column(
                              children: controller.listCardTheme.map(
                                (card) {
                                  return InkWell(
                                    onTap: () => Modular.to
                                        .pushNamed("/description_simulated"),
                                    child: Container(
                                      margin:
                                          EdgeInsets.only(bottom: height * 1.8),
